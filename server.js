...
app.post('/webhook', async (req, res) => {
  ...
  if (Tipodedocumento && cedula) {
    ...
    try {
      ...
      const jobData = {
        "itemData": "{\"Priority\":\"Normal\",\"Name\":\"tesis\",\"SpecificContent\":{\"Name@odata.type\":\"#String\",\"Name\":\"Default\",\"cedula\":\"" + cedula + "\",\"Tipodedocumento\":\"" + Tipodedocumento + "\"},\"Reference\":\"Dialogflow\"}"
      };
